    ...
    document.getElementById('form-add-question').addEventListener('submit',(e) => {
        ...
        const inputAnswer1 = elements[2];
        const inputAnswer2 = elements[6];
        const checkCorrects = [elements[1].checked,elements[5].checked,elements[9].checked,elements[13].checked,elements[17].checked,elements[21].checked,elements[1].checked]
